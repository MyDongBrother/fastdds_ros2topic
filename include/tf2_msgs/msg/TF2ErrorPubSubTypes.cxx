...
namespace tf2_msgs {
    namespace msg {
        ...
        } //End of namespace TF2Error_Constants
        TF2ErrorPubSubType::TF2ErrorPubSubType()
        {
            setName("tf2_msgs::msg::dds_::TF2Error_");
            auto type_size = TF2Error::getMaxCdrSerializedSize();
            type_size += eprosima::fastcdr::Cdr::alignment(type_size, 4); /* possible submessage alignment */
            m_typeSize = static_cast<uint32_t>(type_size) + 4; /*encapsulation*/
            m_isGetKeyDefined = TF2Error::isKeyDefined();
        ...
        void TF2ErrorPubSubType::deleteData(
                void* data)
        {
            delete(reinterpret_cast<TF2Error*>(data));
        }
