...
{
    // m_closed_file com.eprosima.idl.parser.typecode.StringTypeCode@517cd4b
    m_closed_file ="";
    // m_opened_file com.eprosima.idl.parser.typecode.StringTypeCode@679b62af
    m_opened_file ="";
...
rosbag2_interfaces::msg::WriteSplitEvent& rosbag2_interfaces::msg::WriteSplitEvent::operator =(
        const WriteSplitEvent& x)
{
...
bool rosbag2_interfaces::msg::WriteSplitEvent::operator ==(
        const WriteSplitEvent& x) const
{
...
size_t rosbag2_interfaces::msg::WriteSplitEvent::getMaxCdrSerializedSize(
...
size_t rosbag2_interfaces::msg::WriteSplitEvent::getCdrSerializedSize(
        const rosbag2_interfaces::msg::WriteSplitEvent& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void rosbag2_interfaces::msg::WriteSplitEvent::serialize(
...
void rosbag2_interfaces::msg::WriteSplitEvent::deserialize(
 ...
 */
void rosbag2_interfaces::msg::WriteSplitEvent::closed_file(
 ...
 */
const std::string& rosbag2_interfaces::msg::WriteSplitEvent::closed_file() const
{
 ...
 */
std::string& rosbag2_interfaces::msg::WriteSplitEvent::closed_file()
{
    return m_closed_file;
}
/*!
 ...
 */
void rosbag2_interfaces::msg::WriteSplitEvent::opened_file(
 ...
 */
const std::string& rosbag2_interfaces::msg::WriteSplitEvent::opened_file() const
{
 ...
 */
std::string& rosbag2_interfaces::msg::WriteSplitEvent::opened_file()
{
    return m_opened_file;
}

size_t rosbag2_interfaces::msg::WriteSplitEvent::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
bool rosbag2_interfaces::msg::WriteSplitEvent::isKeyDefined()
{
    return false;
}

void rosbag2_interfaces::msg::WriteSplitEvent::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
