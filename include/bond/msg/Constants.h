...
#ifndef _FAST_DDS_GENERATED_BOND_MSG_CONSTANTS_H_
#define _FAST_DDS_GENERATED_BOND_MSG_CONSTANTS_H_
...
namespace bond {
    namespace msg {
        namespace Constants_Constants {
            const float DEAD_PUBLISH_PERIOD = 0.05;
            const float DEFAULT_CONNECT_TIMEOUT = 10.0;
            const float DEFAULT_HEARTBEAT_TIMEOUT = 4.0;
            const float DEFAULT_DISCONNECT_TIMEOUT = 2.0;
            const float DEFAULT_HEARTBEAT_PERIOD = 1.0;
            const std::string DISABLE_HEARTBEAT_TIMEOUT_PARAM = "/bond_disable_heartbeat_timeout";
        } // namespace Constants_Constants
        /*!
         * @brief This class represents the structure Constants defined by the user in the IDL file.
         * @ingroup CONSTANTS
         */
        class Constants
        {
        public:
             ...
             */
            eProsima_user_DllExport Constants();
             ...
             * @param x Reference to the object bond::msg::Constants that will be copied.
             */
            eProsima_user_DllExport Constants(
                    const Constants& x);
             ...
             * @param x Reference to the object bond::msg::Constants that will be copied.
             */
            eProsima_user_DllExport Constants& operator =(
                    const Constants& x);
             ...
             * @param x bond::msg::Constants object to compare.
             */
...
#endif // _FAST_DDS_GENERATED_BOND_MSG_CONSTANTS_H_